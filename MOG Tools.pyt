...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [CalculateMaximumOnGround] # , GenerateAircraftLayer

# class GenerateAircraftLayer(object):
#     def __init__(self):
#         self.label = "Create Aircraft Object Layer"
...
#             with arcpy.da.SearchCursor(object_id, ["LENGTH", "WIDTH", "SHAPE_ANGLE", "LATITUDE", "LONGITUDE", "LCN"]) as search_cursor:
